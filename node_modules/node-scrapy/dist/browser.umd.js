(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('domutils')) :
	typeof define === 'function' && define.amd ? define(['exports', 'domutils'], factory) :
	(global = global || self, factory(global.scrapy = {}, global.domutils));
}(this, function (exports, domutils) { 'use strict';
	...
	*/
	...
	var parse_1 = parse$1; //following http://www.w3.org/TR/css3-selectors/#nth-child-pseudo
	...
	*/
	...
	function (_Error) {
	  ...
	  function ModelError() {
	    ...
	    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ModelError)).call.apply(_getPrototypeOf2, [this].concat(args)));
	...
	function (_Error2) {
	  ...
	  function UnknownFilterError() {
	    ...
	    _this2 = _possibleConstructorReturn(this, (_getPrototypeOf3 = _getPrototypeOf(UnknownFilterError)).call.apply(_getPrototypeOf3, [this].concat(args)));
	  ...
	  (function () {
	    ...
	    var grammar = {
	      ...
	      ParserRules: [{
	        ...
	        "name": "EXTENDED_QUERY",
	        "symbols": ["CSS_COMBINATOR", "__", "QUERY_EXTENSION", "_"],
	        ...
	        "name": "GETTER",
	        "symbols": ["GETTER$string$1", "__", "IDENTIFIER"],
	        "postprocess": function postprocess(d) {
	          return d[2];
	        }
	      }, {
	        ...
	        "postprocess": function postprocess(d, loc, reject) {
	          var token = join(d);
	          return ["null", "true", "false"].includes(token) ? reject : token;
	        }
	      }, {
	        "name": "CSS_COMBINATOR",
	        "symbols": ["SELECTOR_BODY"],
	        "postprocess": join
	      }, {
	        "name": "CSS_COMBINATOR",
	        "symbols": ["CSS_COMBINATOR", "_", /[><+~]/, "_", "SELECTOR_BODY"],
	        "postprocess": join
	      }, {
	        "name": "CSS_COMBINATOR",
	        "symbols": ["CSS_COMBINATOR", "__", "SELECTOR_BODY"],
	        "postprocess": join
	      }, {
	        "name": "SELECTOR_BODY$ebnf$1",
	        "symbols": ["PSEUDO_ELEMENT_SELECTOR"],
	        "postprocess": id
	      }, {
	        "name": "SELECTOR_BODY$ebnf$1",
	        "symbols": [],
	        ...
	        "name": "SELECTOR_BODY",
	        "symbols": ["BASE_SELECTOR", "SELECTOR_BODY$ebnf$1"],
	        "postprocess": join
	      }, {
	        "name": "SELECTOR_BODY$ebnf$2",
	        "symbols": ["PSEUDO_ELEMENT_SELECTOR"],
	        "postprocess": id
	      }, {
	        "name": "SELECTOR_BODY$ebnf$2",
	        ...
	        "name": "SELECTOR_BODY",
	        "symbols": ["COMPOUND_SELECTOR", "SELECTOR_BODY$ebnf$2"],
	        "postprocess": join
	      }, {
	        "name": "SELECTOR_BODY$ebnf$3",
	        "symbols": ["PSEUDO_ELEMENT_SELECTOR"],
	        "postprocess": id
	      }, {
	        "name": "SELECTOR_BODY$ebnf$3",
	        ...
	        "name": "SELECTOR_BODY",
	        "symbols": ["BASE_SELECTOR", "COMPOUND_SELECTOR", "SELECTOR_BODY$ebnf$3"],
	        "postprocess": join
	      }, {
	        "name": "COMPOUND_SELECTOR",
	        "symbols": ["MODIFIER_SELECTOR"],
	        "postprocess": join
	      }, {
	        "name": "COMPOUND_SELECTOR",
	        "symbols": ["COMPOUND_SELECTOR", "MODIFIER_SELECTOR"],
	        "postprocess": join
	      }, {
	        "name": "MODIFIER_SELECTOR",
	        "symbols": ["ID_SELECTOR"],
	        "postprocess": join
	      }, {
	        "name": "MODIFIER_SELECTOR",
	        "symbols": ["CLASS_SELECTOR"],
	        "postprocess": join
	      }, {
	        "name": "MODIFIER_SELECTOR",
	        "symbols": ["ATTRIBUTE_VALUE_SELECTOR"],
	        "postprocess": join
	      }, {
	        "name": "MODIFIER_SELECTOR",
	        "symbols": ["ATTRIBUTE_PRESENCE_SELECTOR"],
	        "postprocess": join
	      }, {
	        "name": "MODIFIER_SELECTOR",
	        "symbols": ["PSEUDO_CLASS_SELECTOR"],
	        "postprocess": join
	      }, {
	        "name": "BASE_SELECTOR",
	        "symbols": ["TYPE_SELECTOR"],
	        "postprocess": join
	      }, {
	        "name": "BASE_SELECTOR",
	        "symbols": ["UNIVERSAL_SELECTOR"],
	        "postprocess": join
	      }, {
	        ...
	        "symbols": [{
	          "literal": "-"
	        }, "NAME_START", "NAME_BODY"],
	        "postprocess": join
	      }, {
	        "name": "CLASS_NAME",
	        "symbols": ["NAME_START", "NAME_BODY"],
	        "postprocess": join
	      }, {
	        "name": "ATTRIBUTE_PRESENCE_SELECTOR",
	        "symbols": [{
	          "literal": "["
	        }, "ATTRIBUTE_NAME", {
	          "literal": "]"
	        ...
	        "name": "ATTRIBUTE_OPERATOR$string$1",
	        "symbols": [{
	          "literal": "~"
	        }, {
	          "literal": "="
	        ...
	        "name": "ATTRIBUTE_OPERATOR",
	        "symbols": ["ATTRIBUTE_OPERATOR$string$1"]
	      }, {
	        "name": "ATTRIBUTE_OPERATOR$string$2",
	        "symbols": [{
	          "literal": "|"
	        }, {
	          "literal": "="
	        ...
	        "name": "ATTRIBUTE_OPERATOR",
	        "symbols": ["ATTRIBUTE_OPERATOR$string$2"]
	      }, {
	        "name": "ATTRIBUTE_OPERATOR$string$3",
	        "symbols": [{
	          "literal": "^"
	        }, {
	          "literal": "="
	        ...
	        "name": "ATTRIBUTE_OPERATOR",
	        "symbols": ["ATTRIBUTE_OPERATOR$string$3"]
	      }, {
	        "name": "ATTRIBUTE_OPERATOR$string$4",
	        "symbols": [{
	          "literal": "$"
	        }, {
	          "literal": "="
	        ...
	        "name": "ATTRIBUTE_OPERATOR",
	        "symbols": ["ATTRIBUTE_OPERATOR$string$4"]
	      }, {
	        "name": "ATTRIBUTE_OPERATOR$string$5",
	        "symbols": [{
	          "literal": "*"
	        }, {
	          "literal": "="
	        ...
	        "name": "ATTRIBUTE_OPERATOR",
	        "symbols": ["ATTRIBUTE_OPERATOR$string$5"]
	      }, {
	        "name": "ATTRIBUTE_VALUE",
	        "symbols": ["UNQUOTED_ATTRIBUTE_VALUE"],
	        "postprocess": join
	      }, {
	        "name": "ATTRIBUTE_VALUE",
	        "symbols": ["STRING"],
	        ...
	        "name": "UNQUOTED_ATTRIBUTE_VALUE$ebnf$1",
	        "symbols": [/[^\[\]"',= ]/]
	      }, {
	        "name": "UNQUOTED_ATTRIBUTE_VALUE$ebnf$1",
	        "symbols": ["UNQUOTED_ATTRIBUTE_VALUE$ebnf$1", /[^\[\]"',= ]/],
	        "postprocess": function arrpush(d) {
	          return d[0].concat([d[1]]);
	        }
	      }, {
	        ...
	        "name": "PSEUDO_ELEMENT_SELECTOR$string$1",
	        "symbols": [{
	          "literal": ":"
	        }, {
	          "literal": ":"
	        ...
	        "symbols": ["PSEUDO_ELEMENT_SELECTOR$string$1", "PSEUDO_SELECTOR_NAME"],
	        "postprocess": join
	      }, {
	        "name": "PSEUDO_CLASS_SELECTOR",
	        "symbols": [{
	          "literal": ":"
	        }, "PSEUDO_SELECTOR_NAME"],
	        "postprocess": join
	      }, {
	        "name": "PSEUDO_CLASS_SELECTOR$ebnf$1",
	        "symbols": []
	      }, {
	        "name": "PSEUDO_CLASS_SELECTOR$ebnf$1",
	        "symbols": ["PSEUDO_CLASS_SELECTOR$ebnf$1", /[^\(\)]/],
	        "postprocess": function arrpush(d) {
	          return d[0].concat([d[1]]);
	        }
	      }, {
	        ...
	        "symbols": [{
	          ...
	          "literal": "("
	        }, "PSEUDO_CLASS_SELECTOR$ebnf$1", {
	          "literal": ")"
	        }],
	        "postprocess": join
	      }, {
	        "name": "PSEUDO_SELECTOR_NAME",
	        "symbols": [/[a-zA-Z]/, "NAME_BODY"],
	        "postprocess": join
	      }, {
	        "name": "NAME_START",
	        "symbols": [/[_a-zA-Z]/],
	        ...
	        "name": "NAME_BODY$ebnf$1",
	        "symbols": [/[a-zA-Z0-9-_]/]
	      }, {
	        "name": "NAME_BODY$ebnf$1",
	        "symbols": ["NAME_BODY$ebnf$1", /[a-zA-Z0-9-_]/],
	        "postprocess": function arrpush(d) {
	          return d[0].concat([d[1]]);
	        }
	      }, {
	        "name": "NAME_BODY",
	        "symbols": ["NAME_BODY$ebnf$1"],
	        "postprocess": join
	      }, {
	        "name": "NUMBER$ebnf$1",
	        "symbols": [{
	        ...
	        "name": "ESCAPED_CHAR",
	        "symbols": ["ESCAPED_CHAR$string$1"],
	        "postprocess": function postprocess() {
	          return '\\';
	        }
	      }, {
	        "name": "ESCAPED_CHAR$string$2",
	        "symbols": [{
	          "literal": "\\"
	        }, {
	          "literal": "/"
	        ...
	        "name": "ESCAPED_CHAR",
	        "symbols": ["ESCAPED_CHAR$string$2"],
	        "postprocess": function postprocess() {
	          return '/';
	        }
	      }, {
	        "name": "ESCAPED_CHAR$string$3",
	        "symbols": [{
	          "literal": "\\"
	        }, {
	          "literal": "n"
	        ...
	        "name": "ESCAPED_CHAR",
	        "symbols": ["ESCAPED_CHAR$string$3"],
	        "postprocess": function postprocess() {
	          return '\n';
	        }
	      }, {
	        "name": "ESCAPED_CHAR$string$4",
	        "symbols": [{
	          "literal": "\\"
	        }, {
	          "literal": "b"
	        ...
	        "name": "ESCAPED_CHAR",
	        "symbols": ["ESCAPED_CHAR$string$4"],
	        "postprocess": function postprocess() {
	          return '\b';
	        }
	      }, {
	        "name": "ESCAPED_CHAR$string$5",
	        "symbols": [{
	          "literal": "\\"
	        }, {
	          "literal": "f"
	        ...
	        "name": "ESCAPED_CHAR",
	        "symbols": ["ESCAPED_CHAR$string$5"],
	        "postprocess": function postprocess() {
	          return '\f';
	        }
	      }, {
	        "name": "ESCAPED_CHAR$string$6",
	        "symbols": [{
	          "literal": "\\"
	        }, {
	          "literal": "r"
	        ...
	        "name": "ESCAPED_CHAR",
	        "symbols": ["ESCAPED_CHAR$string$6"],
	        "postprocess": function postprocess() {
	          return '\r';
	        }
	      }, {
	        "name": "ESCAPED_CHAR$string$7",
	        "symbols": [{
	          "literal": "\\"
	        }, {
	          "literal": "t"
	        ...
	        "name": "ESCAPED_CHAR",
	        "symbols": ["ESCAPED_CHAR$string$7"],
	        "postprocess": function postprocess() {
	          return '\t';
	        }
	      }, {
	        "name": "ESCAPED_CHAR$string$8",
	        "symbols": [{
	          "literal": "\\"
	        }, {
	          "literal": "u"
	        ...
	        "name": "ESCAPED_CHAR",
	        "symbols": ["ESCAPED_CHAR$string$8", "HEX", "HEX", "HEX", "HEX"],
	        "postprocess": function postprocess(d) {
	          var point = Number.parseInt(join(d.slice(1)), 16);
	          if (point === 92) return '\\';
	...
	var compiledGrammar = nearley.Grammar.fromCompiled(grammar);
	/**
	...
	function parseQuery(query) {
	  ...
	  parser.feed(query); // Return the first result
	...
	function extractItem(dom, item, selectorEngine, getters, filters) {
	  if (isArray$1(item)) {
	    ...
	    var matches = selectorEngine.selectAll(queryAST.selector, dom);
	  ...
	  if (isString$1(item)) {
	    var query = parseQuery$1(item);
	    var match = selectorEngine.selectOne(query.selector, dom);
	    if (!match) return null;
	    var data = resolveGetter(getters, query)(match);
	...
	var browser_1 = browser.extract;

	exports.default = browser;
	exports.extract = browser_1;
